...
public class LikeController {
    ...
    @Operation(summary = "Get recipe like statistics", description = "Retrieves like and dislike statistics for the specified recipe, including user's like/dislike status")
    @ApiResponses(value = {
