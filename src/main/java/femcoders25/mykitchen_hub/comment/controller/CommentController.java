...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponseDto>> createComment(@PathVariable Long recipeId,
    ...
    public ResponseEntity<ApiResponse<List<CommentResponseDto>>> getCommentsByRecipeId(@PathVariable Long recipeId) {
